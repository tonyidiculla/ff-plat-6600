-- Create comprehensive CRUD function with ALL 46 columns and correct types
...
CREATE OR REPLACE FUNCTION public.crud_entity_master_l01(
    ...
    -- DATE/TIMESTAMP columns (3 total)
    p_incorporation_date DATE DEFAULT NULL,
    p_deleted_at TIMESTAMPTZ DEFAULT NULL,
    
    -- JSONB columns (3 total)
...
BEGIN
    ...
    CASE operation
        ...
        WHEN 'UPDATE' THEN
            ...
            -- Update with all columns grouped by type
...
-- Comment
COMMENT ON FUNCTION public.crud_entity_master_l01 IS 'Complete CRUD function for entity_master_l01 with all 46 columns and correct types';