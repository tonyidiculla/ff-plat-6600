-- Fix the final COALESCE type mismatch

-- Drop the problematic function
DROP FUNCTION IF EXISTS public.crud_entity_master_l01;

-- Create comprehensive CRUD function with explicit NULL handling for UUID fields
...
BEGIN
    ...
    CASE operation
        ...
        WHEN 'UPDATE' THEN
            ...
            -- Update using conditional assignment to avoid type mismatches
            UPDATE global.entity_master_l01 SET
                ...
                -- Handle special field types separately
...
-- Comment
COMMENT ON FUNCTION public.crud_entity_master_l01 IS 'Complete CRUD function for entity_master_l01 with CASE statements to avoid type mismatches';