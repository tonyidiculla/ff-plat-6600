-- Simple comprehensive CRUD function with all fields

-- Drop any existing function
DROP FUNCTION IF EXISTS public.crud_entity_master_l01;

-- Create working CRUD function with all fields using CASE statements instead of COALESCE
CREATE OR REPLACE FUNCTION public.crud_entity_master_l01(
    ...
    p_assigned_manager_id TEXT DEFAULT NULL,  -- Text to avoid UUID conversion issues
...
BEGIN
    ...
    CASE operation
        ...
        WHEN 'UPDATE' THEN
            ...
            -- Handle UUID conversion for assigned_manager_id
            BEGIN
            ...
            -- Update using CASE statements instead of COALESCE
            UPDATE global.entity_master_l01 SET
                ...
                assigned_manager_id = CASE WHEN p_assigned_manager_id IS NOT NULL THEN assigned_manager_uuid ELSE assigned_manager_id END,
...
-- Comment
COMMENT ON FUNCTION public.crud_entity_master_l01 IS 'Comprehensive CRUD function for all entity fields using CASE statements';