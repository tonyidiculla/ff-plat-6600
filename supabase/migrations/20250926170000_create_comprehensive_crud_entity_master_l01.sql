-- Drop existing crud_entity_master_l01_function and create new crud_entity_master_l01 function
-- that supports all columns of entity_master_l01 table

-- Drop the existing function
DROP FUNCTION IF EXISTS public.crud_entity_master_l01_function;

-- Create new comprehensive CRUD function for entity_master_l01
...
BEGIN
    ...
    CASE operation
        WHEN 'CREATE' THEN
            ...
            -- Insert new entity
            INSERT INTO public.entity_master_l01 (
        ...
        WHEN 'READ' THEN
            ...
            ELSE
                ...
                FROM (
                    SELECT * FROM public.entity_master_l01
        ...
        WHEN 'UPDATE' THEN
            ...
            UPDATE public.entity_master_l01 SET
...
-- Add comment
COMMENT ON FUNCTION public.crud_entity_master_l01 IS 'Comprehensive CRUD function for entity_master_l01 table supporting all columns';