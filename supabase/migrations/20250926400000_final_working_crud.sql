-- Create the final working CRUD function with simplified CASE approach
...
CREATE OR REPLACE FUNCTION public.crud_entity_master_l01(
    ...
    -- Entity parameters (essential fields for organization management)
...
BEGIN
    ...
    CASE operation
        ...
        WHEN 'UPDATE' THEN
            ...
            -- Use simple CASE WHEN approach for conditional updates
...
-- Comment
COMMENT ON FUNCTION public.crud_entity_master_l01 IS 'Final comprehensive CRUD function for entity_master_l01 with all essential fields for organization management';